...
def crawl_wishket():
    with sync_playwright() as p:
        ...
        page.fill('input[name="emailOrId"]', 'tkwk651@naver.com')
        page.fill('input[name="password"]', 'Nopen4532@')
        ...
        save_path = f"C:/Users/Nopen/Desktop/LLTTYY/soldesk/source/pythonsource/Bigpy/Py_Scrap/data/wishket_{today}.json"
        with open(save_path, "w", encoding="utf-8") as f:
            json.dump(result, f, ensure_ascii=False, indent=2)

        # 2) 누적 기록용 csv에도 한 줄 추가
        csv_path = "C:/Users/Nopen/Desktop/LLTTYY/soldesk/source/pythonsource/Bigpy/Py_Scrap/data/wishket_history.csv"
